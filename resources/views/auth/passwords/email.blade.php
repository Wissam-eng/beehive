                        ...
                        <div class="mx-auto w-full max-w-[440px]">
                            ...
                            <div class="mb-10">
                                <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl">
                                    Reset password</h1>
                                <p class="text-base font-bold leading-normal text-white-dark">Enter your email to send
                                    your otp</p>
                            </div>
                            <form class="space-y-5 dark:text-white" method="POST" action="{{ route('sendOtp') }}">
                                @csrf
                                @method('POST')
                                <div>
