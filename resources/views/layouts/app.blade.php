...
<head>
    ...
    <title>khaleiatnahel</title>
    <link rel="icon" href="{{ asset('storage/images/logoo.png') }}">
                        ...
                        <div class="menu nav-item">
                            <button type="button" class="nav-link group"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">اضافة
                                        مستخدم</span>
                                </div>
                                <div class="rtl:rotate-180"
                                    :class="{ '!rotate-90': activeDropdown === 'dashboard' }">
